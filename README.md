...
- **Mini-Dice Roller** — Console app that rolls three dice, calculates the total score with bonus logic for doubles and triples, and determines the prize based on scoring tiers. The program uses the Random class and .Next() method to simulate dice rolls, and conditional statements to handle scoring and prize logic.